...
class ProcessingPipeline:
    ...
    def generate_outbound_excel(self, declaration_period: str) -> bytes:
        """
        Generate Excel file with only Outbound declarations.
        ...
        Returns:
            Excel file as bytes
        """
        buffer = self.excel_generator.generate_outbound_only(
            self.outbound_shipments,
            declaration_period
        )
        ...
        # Log export
        for shipment in self.outbound_shipments:
            self.audit.log_export(shipment.invoice_number, "Excel-Outbound")
